...
This is not meant to be taken seriously, but is very functional. More of a proof of concept.
The SC launcher Now includes this functionality, and is the prefered method.
This script does not modify and Star Citizen files. It simply moves the cashe files to the recycle bin. That's it!
